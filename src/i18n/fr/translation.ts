export default {
  attendingBlock: {
    ...
    name: "Votre nom: (veuillez corriger des erreurs d'orthograpie)",
  },
  childAttendingBlock: {
    childName: "Nom d'enfant {{count}}:",
    bringOwnFood: "Nous apporterons leur propre repas",
    highchair: "Une chaise haute sera nćessaire",
    description: "Merci de prevoir un menu d'enfant (Entrée: Aiguillettes de poulets, sauce BBQ, Plat: Linguine à la tomate Dessert: Cookie au pépites de chocolat)",
  },
  common: {
    and: "&",
    button: {
      submit: "Envoyer {{extra}}",
  ...
  details: {
    ...
    contactUs: {
      description:
        "Si vous avez des questions concernant le voyage, le lieu de réception ou toute autre chose, n'hesitez pas à nous contactez.",
      nat: "Le jour du mariage : Veuille contacter notre demoiselle d'honneur, Natalie au  <1>+44 7736 350 670</1>.",
    ...
    map: "Plan",
    runningOrder: {
      breakfast: "Dîner de mariage",
      carriages: "Fin des festivités",
      ceremony: "La cérémonie",
      cutting: "Découpe du gâteau",
      dancing: "Soirée dansante",
      drinks: "Vin d'honneur, canapés et photos",
      seated: "Instalation des invités",
      speeches: "Discours et toasts",
  ...
  invited: {
    ...
    error: {
      ...
      noUserHelp:
        "Veuillez vérifier que l'orthographe correspond bien à celle de votre invitation. Si le problème persiste, n'hésitez pas a nous contacter directement.",
      noFirstLast: "Veuillez renseigner votre prénom et votre nom de famille.",
    },
  },
  isAttending: {
    children:
    ...
    notes:
      "Souhaitez-vous nous faire part d'autres chose? N'hesitez pas a nous transmettre toute information ou demande particuliere ici - qu'il s'agisse de besoin en matiêre d'accessibilité, de questions sur transport ou de toute autre élélement pouvant rendre votre journé plus agréable.",
  },
  isNotAttending: {
    text1: "Vous allez nous manquer !",
    text2:
      "Merci de nous avoir prévenus. Nous sommes désolés que vous ne puissiez pas venir, mais nous comprenons tout à fait.",
    text3:
      "N'hesitez pas à parcourir notre site si vous souhaiteez consulter les détails de notre jour. Nous ne manquerons pas de partager les photos avec vous après le grand jour !",
    text4:
      "Si vous souhaitez nous laisser un message ou vos voeux de boheur, n'hesitez pas à les partager ici :",
  },
  form: {
    submitSuccessHeader: "Merci pour votre réponse",
    submitSuccessBody:
      "Si vous avez besoin de modifier quoi que ce soit avant le 1er juillet, il vous suffit de revenir sur le site pour metre à jour votre formulaire. ",
    ...
    respondBy: "Merci de nous confirmer votre présence avant le",
    respondByDate: "1er July 2026",
    description:
      "<1>Bienvenue {{- names}}. Nous sommes tellement excités de partager cette journée avec vous. Si ce n'est pas vous, merci de <2>cliquez ici pour changer d'uilisateur</2></1>.",
    descriptionReceived:
      "<1>Merci {{- names}}. Nous avons déjà reçu votre réponse. Si ce n'est pas vous, merci de <2>cliquez ici pour changer d'utilisateur</2></1>",
    editButton: "Modifier ma réponse",
    submit: "Envoyer ma réponse",
  },
  mealSelector: {
    title: "Le menu. Veuillez selectioner vos {{- partner_possessive}} choix pour le dîner de mariage ci-dessous :",
    starter: "Entrée",
    main: "Plat Principal",
    dessert: "Dessert",
    partner: " Partenaire",// keep the space at the front
    partner_possessive: " de votre partenaire", // keep the space
    placeholder: "Selectionnez votre {{type}}",
    placeholder_partner: "Selectionnez {{type}} du votre partenaire"
  },
} as const;
